...
if (isset($_POST['upload'])) {
    ...
    $sql = "INSERT INTO aboniment (theme, message, image, price) VALUES ('$theme', '$message', '$image', '$price')";
    mysqli_query($db, $sql);
...
if (isset($_POST['buy'])) {
    $id = $_POST['buy'];
    $result = mysqli_query($db, "SELECT * FROM aboniment WHERE id = '$id'");
...
$result = mysqli_query($db, "SELECT * FROM aboniment");
?>
...
<body>
    ...
    <form action="abb.php" method="post" enctype="multipart/form-data">
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            echo "<button name='buy' value='". $row['id']. "'>Купить</button>"; // Add a unique value to the button
            echo "</div>";
        }
       ?>
    </form>
